...
public class Main {
    public static void main(String[] args) {
        ...
        person1.setpersonName("Student");
        person1.setpersonLastName("Student");
        person1.setpersonMail("example@protonmail.com");
        ...
        person2.setpersonName("Student");
        person2.setpersonLastName("Chalabi");
        person2.setpersonMail("example@protonmail.com");
